...
const cases = [
  { id: 1, year: "2023.", client: "Investitor u energetsku infrastrukturu", subject: "Žalba na dokumentaciju pred DKOM-om", outcome: "Dobiveno", value: "4,2 mil. EUR" },
  { id: 2, year: "2022.", client: "Konzorcij za gradnju cesta", subject: "Upravni spor pred DKOM-om", outcome: "Dobiveno", value: "12,5 mil. EUR" },
  { id: 3, year: "2022.", client: "Pružatelj ekoloških usluga", subject: "Osporavanje abnormalno niske ponude", outcome: "Dobiveno", value: "1,8 mil. EUR" },
  { id: 4, year: "2021.", client: "Poduzeće za upravljanje šumama", subject: "Žalba zbog kršenja jednakog postupanja", outcome: "Dobiveno", value: "3,1 mil. EUR" },
  { id: 5, year: "2021.", client: "Inženjersko-projektantski biro", subject: "Spor oko tehničke sposobnosti", outcome: "Dobiveno", value: "2,4 mil. EUR" },
  { id: 6, year: "2020.", client: "Investitor u obnovljivu energiju", subject: "Konzultacije pri sklapanju ugovora", outcome: "Dobiveno", value: "7,6 mil. EUR" },
  { id: 7, year: "2020.", client: "Izvođač javnih usluga", subject: "Priprema i podnošenje ponude", outcome: "Dobiveno", value: "5,3 mil. EUR" },
  { id: 8, year: "2019.", client: "Operator za gospodarenje otpadom", subject: "Žalba na odluku naručitelja", outcome: "Dobiveno", value: "2,9 mil. EUR" },
]

const columns = [
  { key: "year", header: "Godina", sortable: true, width: "90px" },
  { key: "client", header: "Klijent / sektor", sortable: true, filterable: true },
  { key: "subject", header: "Predmet", sortable: true, filterable: true },
  { key: "outcome", header: "Ishod", sortable: true, width: "110px" },
  { key: "value", header: "Vrijednost ugovora", sortable: true, width: "150px" },
]
          ...
          <div className="header__contact">
            ...
            >
              ...
              <div className="header__lang-menu" role="menu" aria-label="Jezične opcije">
                <a href="/expertise/public-procurement" className="header__lang-option" role="menuitem" onClick={() => setLangOpen(false)}>en</a>
        ...
        <section className="expertise-detail">
          <div className="container">
            ...
            <div className="expertise-detail__content">
              ...
              <p>
                Osim toga, ured ima značajno iskustvo u zastupanju klijenata u sudskim i arbitražnim postupcima pokrenutima povodom sporova koji proizlaze iz javnih ugovora.
              </p>
              <p>
            ...
            <div className="expertise-detail__table">
              ...
              <DataTable
                ...
                columns={columns}
                searchable
                searchPlaceholder="Pretražite predmete..."
                itemsPerPage={5}
                showPagination
                emptyMessage="Nema pronađenih predmeta"
              />
            </div>
          </div>
        </section>
